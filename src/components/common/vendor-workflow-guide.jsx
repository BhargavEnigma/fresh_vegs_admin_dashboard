    ...
    manager: {
      en: [
        {
          ...
          nav: "Sidebar ➔ Vendor Check-In",
          desc: "Select the current delivery date and select the vendor name from the dropdown list to see what vegetables they are scheduled to deliver to the warehouse.",
          icon: Warehouse,
          badge: "Step 1",
        },
        {
          title: "Record Received & Rejected Qty",
          nav: "Sidebar ➔ Vendor Check-In ➔ Vendor Rows",
        ...
        {
          title: "Submit Check-In Entry",
          nav: "Sidebar ➔ Vendor Check-In ➔ Click 'Submit Check-In'",
          desc: "Click the 'Submit Check-In' button. This updates warehouse inventory and calculates payout from the vendor price locked when the assignment was created.",
          icon: CheckCircle2,
          badge: "Step 3",
        },
      ],
      gu: [
        ...
        },
        {
          ...
          nav: "Sidebar ➔ Vendor Check-In ➔ વેન્ડર પ્રોડક્ટ લાઇન",
        ...
        {
          title: "ચેક-ઇન સબમિટ કરવું (Submit)",
          nav: "Sidebar ➔ Vendor Check-In ➔ 'Submit Check-In' બટન",
          desc: "માહિતી ભરાઈ ગયા બાદ છેલ્લે 'Submit Check-In' બટન પર ક્લિક કરો. આનાથી વેરહાઉસનો સ્ટોક વધી જશે અને વેન્ડરનું પેમેન્ટ ઓટોમેટિક કેલ્ક્યુલેટ થશે.",
          icon: CheckCircle2,
          badge: "પગલું ૩",
        },
      ],
